...
const   months_long_est = ['jaanuar', 'veebruar', 'märts', 'aprill', 'mai', 'juuni', 'juuli', 'august', 'september', 'oktoober', 'november', 'detsember'],
        ...
        // Nädalapäevade nimetused eesti keeles
        weekdays_short_est = ['E', 'T', 'K', 'N', 'R', 'L', 'P'],
        ...
        constel_params = {
            'For' : {'noun' : 'Ahi',                'gen' : 'Ahju'},
            'Pup' : {'noun' : 'Ahter',              'gen' : 'Ahtri'},
            'Ara' : {'noun' : 'Altar',              'gen' : 'Altari'},
            'Sgr' : {'noun' : 'Ambur',              'gen' : 'Amburi'},
            'And' : {'noun' : 'Andromeeda',         'gen' : 'Andromeeda'},
            'Com' : {'noun' : 'Bereniike Juuksed',  'gen' : 'Bereniike Juuste'},
            'Del' : {'noun' : 'Delfiin',            'gen' : 'Delfiini'},
            'Eri' : {'noun' : 'Eriidanus',          'gen' : 'Eriidanuse'},
            'Phe' : {'noun' : 'Fööniks',            'gen' : 'Fööniksi'},
            'Her' : {'noun' : 'Herkules',           'gen' : 'Herkulese'},
            'Equ' : {'noun' : 'Hobu',               'gen' : 'Hobu'},
            'Lup' : {'noun' : 'Hunt',               'gen' : 'Hundi'},
            'Hya' : {'noun' : 'Hüdra',              'gen' : 'Hüdra'},
            'Lyn' : {'noun' : 'Ilves',              'gen' : 'Ilvese'},
            'Ind' : {'noun' : 'Indiaanlane',        'gen' : 'Indiaanlase'},
            'CVn' : {'noun' : 'Jahipenid',          'gen' : 'Jahipenide'},
            'Lep' : {'noun' : 'Jänes',              'gen' : 'Jänese'},
            'Ari' : {'noun' : 'Jäär',               'gen' : 'Jäära'},
            'Lib' : {'noun' : 'Kaalud',             'gen' : 'Kaalude'},
            'Crv' : {'noun' : 'Kaaren',             'gen' : 'Kaarna'},
            'Cam' : {'noun' : 'Kaelkirjak',         'gen' : 'Kaelkirjaku'},
            'Gem' : {'noun' : 'Kaksikud',           'gen' : 'Kaksikute'},
            'Psc' : {'noun' : 'Kalad',              'gen' : 'Kalade'},
            'Cap' : {'noun' : 'Kaljukits',          'gen' : 'Kaljukitse'},
            'Cha' : {'noun' : 'Kameeleon',          'gen' : 'Kameeleoni'},
            'Crt' : {'noun' : 'Karikas',            'gen' : 'Karika'},
            'Boo' : {'noun' : 'Karjane',            'gen' : 'Karjase'},
            'Cas' : {'noun' : 'Kassiopeia',         'gen' : 'Kassiopeia'},
            'Cep' : {'noun' : 'Kefeus',             'gen' : 'Kefeuse'},
            'Hor' : {'noun' : 'Kell',               'gen' : 'Kella'},
            'Cen' : {'noun' : 'Kentaur',            'gen' : 'Kentauri'},
            'Car' : {'noun' : 'Kiil',               'gen' : 'Kiilu'},
            'Sct' : {'noun' : 'Kilp',               'gen' : 'Kilbi'},
            'Tri' : {'noun' : 'Kolmnurk',           'gen' : 'Kolmnurga'},
            'Pyx' : {'noun' : 'Kompass',            'gen' : 'Kompassi'},
            'Aql' : {'noun' : 'Kotkas',             'gen' : 'Kotka'},
            'Scl' : {'noun' : 'Kujur',              'gen' : 'Kujuri'},
            'Dor' : {'noun' : 'Kuldkala',           'gen' : 'Kuldkala'},
            'Gru' : {'noun' : 'Kurg',               'gen' : 'Kure'},
            'Mus' : {'noun' : 'Kärbes',             'gen' : 'Kärbse'},
            'Men' : {'noun' : 'Lavamägi',           'gen' : 'Lavamäe'},
            'Vol' : {'noun' : 'Lendkala',           'gen' : 'Lendkala'},
            'Dra' : {'noun' : 'Lohe',               'gen' : 'Lohe'},
            'Cyg' : {'noun' : 'Luik',               'gen' : 'Luige'},
            'Hyi' : {'noun' : 'Lõunahüdra',         'gen' : 'Lõunahüdra'},
            'PsA' : {'noun' : 'Lõunakala',          'gen' : 'Lõunakala'},
            'TrA' : {'noun' : 'Lõunakolmnurk',      'gen' : 'Lõunakolmnurga'},
            'CrA' : {'noun' : 'Lõunakroon',         'gen' : 'Lõunakrooni'},
            'Cru' : {'noun' : 'Lõunarist',          'gen' : 'Lõunaristi'},
            'Leo' : {'noun' : 'Lõvi',               'gen' : 'Lõvi'},
            'Lyr' : {'noun' : 'Lüüra',              'gen' : 'Lüüra'},
            'Pic' : {'noun' : 'Maalija',            'gen' : 'Maalija'},
            'Ser' : {'noun' : 'Madu',               'gen' : 'Mao'},
            'Oph' : {'noun' : 'Maokandja',          'gen' : 'Maokandja'},
            'Mic' : {'noun' : 'Mikroskoop',         'gen' : 'Mikroskoobi'},
            'Vir' : {'noun' : 'Neitsi',             'gen' : 'Neitsi'},
            'Sge' : {'noun' : 'Nool',               'gen' : 'Noole'},
            'Oct' : {'noun' : 'Oktant',             'gen' : 'Oktandi'},
            'Ori' : {'noun' : 'Orion',              'gen' : 'Orioni'},
            'Pav' : {'noun' : 'Paabulind',          'gen' : 'Paabulinnu'},
            'Aps' : {'noun' : 'Paradiisilind',      'gen' : 'Paradiisilinnu'},
            'Peg' : {'noun' : 'Pegasus',            'gen' : 'Pegasuse'},
            'Per' : {'noun' : 'Perseus',            'gen' : 'Perseuse'},
            'Ant' : {'noun' : 'Pump',               'gen' : 'Pumba'},
            'Vel' : {'noun' : 'Purjed',             'gen' : 'Purjede'},
            'CrB' : {'noun' : 'Põhjakroon',         'gen' : 'Põhjakrooni'},
            'Vul' : {'noun' : 'Rebane',             'gen' : 'Rebase'},
            'Sex' : {'noun' : 'Sekstant',           'gen' : 'Sekstandi'},
            'Cir' : {'noun' : 'Sirkel',             'gen' : 'Sirkli'},
            'Lac' : {'noun' : 'Sisalik',            'gen' : 'Sisaliku'},
            'Sco' : {'noun' : 'Skorpion',           'gen' : 'Skorpioni'},
            'CMa' : {'noun' : 'Suur Peni',          'gen' : 'Seeure Peni'},
            'UMa' : {'noun' : 'Suur Karu',          'gen' : 'Suure Karu'},
            'Tau' : {'noun' : 'Sõnn',               'gen' : 'Sõnni'},
            'Tel' : {'noun' : 'Teleskoop',          'gen' : 'Teleskoobi'},
            'Tuc' : {'noun' : 'Tuukan',             'gen' : 'Tuukani'},
            'Col' : {'noun' : 'Tuvi',               'gen' : 'Tuvi'},
            'Cae' : {'noun' : 'Uurits',             'gen' : 'Uuritsa'},
            'Cet' : {'noun' : 'Vaal',               'gen' : 'Vaala'},
            'Aqr' : {'noun' : 'Veevalaja',          'gen' : 'Veevalaja'},
            'Aur' : {'noun' : 'Veomees',            'gen' : 'Veomehe'},
            'Nor' : {'noun' : 'Vinkel',             'gen' : 'Vinkli'},
            'Cnc' : {'noun' : 'Vähk',               'gen' : 'Vähi'},
            'LMi' : {'noun' : 'Väike Lõvi',         'gen' : 'Väikese Lõvi'},
            'CMi' : {'noun' : 'Väike Peni',         'gen' : 'Väikese Peni'},
            'UMi' : {'noun' : 'Väike Karu',         'gen' : 'Väikese Karu'},
            'Ret' : {'noun' : 'Võrk',               'gen' : 'Võrgu'},
            'Mon' : {'noun' : 'Ükssarvik',          'gen' : 'Ükssarviku'}
        };
 ...
 */
function timeformat (t, daylabel='none', date=true, months='num', year=true, years='long', time=true, secs=true, tz=false, utc=false, zeropad=false) {
    ...
    // Päeva nimi
    if (daylabel != 'none') {
        if      (daylabel == 'rel') { out += dayname(t); }
        else if (daylabel == 'wd')  { out += weekdays_short_est[((utc ? t.getUTCDay() : t.getDay())+6)%7]; }

        if ((date || year || time || tz) && out != '') {
            out += (daylabel == 'rel' ? ', ' : '&nbsp;&nbsp;');
        }
    }
    ...
    if (date) {
        const
            day = utc ? t.getUTCDate() : t.getDate(),
            mon = utc ? t.getUTCMonth() : t.getMonth();

        out += (zeropad ? String(day).padStart(2,'0') : day) + '.';

        if      (months == 'num')    {out += String(mon+1).padStart(2,'0');}
        else if (months == 'long')   {out += months_long_est[mon];}
        else if (months == 'short')  {out += months_short_est[mon];}
    }
    
    // Aastaarv
    if (year) {
        if (date) {out += months == 'num' ? '.' : ' ';}
        out += utc ? t.getUTCFullYear() : t.getFullYear();
    ...
    if (time) {
        ...
        const
            hr = utc ? t.getUTCHours() : t.getHours(),
            min = utc ? t.getUTCMinutes() : t.getMinutes();

        out += (zeropad ? String(hr).padStart(2,'0') : hr) + ':' + String(min).padStart(2,'0');

        if (secs)   {out += ':' + String(utc ? t.getUTCSeconds() : t.getSeconds()).padStart(2,'0');}
    }

    // Ajavöönd
    if (tz) {
        if (date || year || time) {out += ' ';}
        out += 'UTC'+ (utc ? '' : tzstring(t));
    }
...
/**
 * Funktsioon ajavööndi nihke vormindamiseks
 * 
 * @arg {Date | AstroTime}  t
 * @returns {string}        Ajavöönd kujul ±hh:mm
 */
function tzstring (t) {
    if      (t instanceof Astronomy.AstroTime)  { t = t.date; }
    else if (! t instanceof Date)               { throw('datestring: argument is not Date or AstroTime'); }

    let str = t.toString().split('GMT');
    return str[1].slice(0,3)+':'+str[1].slice(3,5);
}
 ...
 * 
 * @arg {Date | AstroTime | ut} t1 - vaatlusaeg või vaatlusvahemiku algus
...
/**
 * Otsing, millal valitud taevakeha ületab tähtkujude piiri. Esialgne otsisamm on 3 tundi.
 * Argumente saab esitada kahel moel:
 *  1) t1 ja t2 - otsitakse piiriületusi t1 ja t2 vahemikus. Kui first=true, tagastatakse ainult esimene
 *  2) t1 - tagastatakse esimene piiriületus alates algusajast (first automaatselt true)
 *  !! TODO 2) ei tööta !!
 * 
 * @arg {string}                body - vaadeldava taevakeha nimetus ('Moon', 'Sun' või üks 8 planeedist)
 * @arg {Date | AstroTime | ut} t1 - otsimisvahemiku algus
 * @arg {Date | AstroTime | ut} t2 - otsimisvahemiku lõpp (valikuline)
 * @arg {boolean}               first - tagasta ainult esimene vahetus (vaikimisi ei)
 * 
 * @returns {Object[]} - tulemuste list, võib sisaldada 0, 1 või enam väärtust.
 *                       Võtmed:
 *                          t - tähtkujupiiri ületamise aeg
 *                          c1 - lähtetähtkuju (IAU lühend)
 *                          c2 - saabumistähtkuju (IAU lühend)
 */
function constelchange (body, first=false, t1, t2=Infinity, d=0.125, dtol=1e-4) {
    
    let T1 = Astronomy.MakeTime(t1),
        T2 = null,
        v = Astronomy.GeoVector(body, T1, true),
        eq = Astronomy.EquatorFromVector(v),
        c1 = Astronomy.Constellation(eq.ra, eq.dec).symbol,
        c2 = '',
        out = [];
    ...
    do {
        v = Astronomy.GeoVector(body, T+d, true);
        eq = Astronomy.EquatorFromVector(v);
        c2 = Astronomy.Constellation(eq.ra, eq.dec).symbol;
        
        if (c2 != c1) {
            
            //console.log(T, T+d, timeformat(Astronomy.MakeTime(T),false,false,'num',false,'short',true,true,false), timeformat(Astronomy.MakeTime(T+d),false,false,'num',false,'short',true,true,false), c1, c2, d, dtol)

            if (d < dtol) {
                return [{
                    'time' : Astronomy.MakeTime((2*T+d)/2),
                    'c1'   : c1,
                    'c2'   : c2
                }];
            } else { out.push(constelchange(body, true, T, T+d, d/10)[0]); }
